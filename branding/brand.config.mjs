export default {
  ...
  demo: ["$ social-preview-doctor https://example.com --bot twitter","Final URL: https://example.com/","OG:image: https://example.com/og.png","Twitter card: summary_large_image"],
  output: ["bot: twitter","final: https://example.com/","og:image: https://example.com/og.png","baseline diff: 0"],
